...
تأتي جاذبية بعض الصور من حركة صغيرة أو تعبير أو علاقة عابرة. إذا رُسم كل شيء بالتفصيل غابت اللحظة وسط التفاصيل، وإذا حُوّلت إلى رسم متجهي نظيف ضاع أثر اليد وروح الدعابة. وكلما كثرت الألوان، تراجع حضور اللمسة الوحيدة التي تستحق أن تُحفظ في الذاكرة.

يختزل **Panel 062** المشهد المعقد إلى شكل مركزي وعدد قليل من الرموز، ويحافظ على الهوية بخطوط سوداء تبدو غير متقنة قليلاً، ثم يحتفظ بلون إبراز واحد هو الأكثر حيوية في الصورة الأصلية. يحتضن التخطيط الاحترافي هذا النقص المقصود، فتبدو النتيجة من بعيد منضبطة ومن قريب ودودة.

### استخدمه في هذه الحالات

- **عندما تريد استخلاص لحظة ذكية من صورة معقدة:** يجب الحفاظ على هوية الموضوع والعلاقات الأساسية، بينما يمكن أن تتراجع الخلفية والتفاصيل الثانوية.
- **عندما تحب الخطوط الساذجة لكنك لا تريد رسماً طفولياً بسيطاً:** يجب أن تتعايش الاهتزازات والانقطاعات وآثار التصحيح مع مقياس ونقطة ثقل ومساحات فارغة ناضجة.
- **عندما تريد أن يصبح اللون نقطة الذاكرة:** يحتفظ العمل كله بلون إبراز واحد من الصورة الأصلية كي لا تسرق لوحة متعددة الألوان التركيز.
...
> استخدم XXD Panel 062 لهذه الصورة، واقترح أولاً أنسب تكوين ومقاس.
...
## تحقق سريع: هل XXD Panel 062 مناسب لك؟

| ما الذي يهمك؟ | ما الذي يقدمه هذا الأسلوب؟ |
|---|---|
| **النتيجة التي ستحصل عليها** | استخدم خطوطًا سوداء ساذجة ولونًا مميزًا من الصورة المصدر للحفاظ على اللحظات الذكية في الصورة |
| **السمات التي تُعرف من النظرة الأولى** | خط أسود طفولي · لون مميز واحد · ذكي وأخرق · خلفية فاتحة جدًا · فارغ تحريري |
...
فهو يضغط الصورة المعقدة في شكل أساسي واحد يمكن التعرف عليه على الفور وبعض العلامات الداعمة. يحافظ الرسم الأسود غير المستقر على الهوية والعلاقات، في حين أن اللون الزاهي الوحيد الذي يتم تذكره من المصدر يحمل اللكنة؛ التباعد المهني يدعم النقص المتعمد.

```text
قفل الهوية والكفاف والعلاقات الرئيسية ← ضغطها في شكل أساسي واحد ← إنشاء خط أسود من خلال التمايل والفواصل وعلامات التصحيح ← الاحتفاظ بلون ذاكرة واحد من المصدر ← إنشاء نظام احترافي من خلال تباين المقياس والمساحة ← إضافة أثر فقط للملاحظة المكتوبة بخط اليد
```

## السمات التي تميّز الأسلوب النهائي

- شكل أساسي واحد وبعض الرموز الضرورية يحمل القصة بأكملها؛ تم تقليل المشهد المعقد عمدًا.
- الخطوط السوداء تتمايل وتتكسر وتبحث وتبالغ بسذاجة بدلاً من أن تصبح فن خط رقمي مصقول.
- يظهر لون تمييزي واحد فقط مشتق من المصدر، في منطقة صغيرة جدًا، مثل تفاصيل حية تحتفظ بها الذاكرة.
- يمكن أن يجلس الهدف بعيدًا عن المركز، أو يطفو، أو يستقر على مستوى منخفض بينما تعمل المساحات الفارغة الكبيرة على تشكيل التركيبة بشكل فعال.
- يُقرأ من بعيد أنه منضبط ومهني؛ عن قرب، يبدو الأمر دافئًا وغريبًا ومصححًا بشكل واضح - الإحراج الذكي المقصود.

توجد القيود الجمالية وقواعد الرفض فقط في [الموجّه الصيني الأصلي](references/original-prompt/zh-CN.md)، بينما يتولى الـ Skill ومهايئ التشغيل متغيرات التسليم فقط. [سير عمل Skill](SKILL.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-062-prompt.en.md)
...
عند تمرير مجلد صور مباشرةً، تعالجه مهارة الجندي دفعةً واحدة بالجمالية الأصلية نفسها لـ Panel 062. تفحص المهارة صيغ الصور النقطية الشائعة تكرارياً، وتعلن العدد، ثم تحسم النمط والحجم والنص واللغة مرة واحدة. تُولَّد كل صورة باستقلال من دون تسرب المحتوى أو النص بين العناصر، وتبقى الدفعة كلها داخل مجلد مهمة مسطح واحد. يُسجَّل فشل أي عنصر من دون إسقاط الصور اللاحقة بصمت.
...
/xxd-panel-062 photo.jpg --mode top-bottom --size auto --text prompt --locale ar-SA
...
/xxd-panel-062 photo.jpg --mode design-only --size 9:16 --text prompt --locale ar-SA
...
/xxd-panel-062 photo.jpg --mode design-only --size 3:4 --copy "دع الضوء يبقى هنا" --locale ar-SA

# نمطان × ثلاثة أحجام ينتجان ستة تكوينات كاملة مستقلة
/xxd-panel-062 photo.jpg --mode top-bottom,design-only --size 1:1,3:4,9:16 --text prompt --locale ar-SA

# تطبيق Panel 062 على مجلد كامل مع حسم الإعدادات المشتركة مرة واحدة
/xxd-panel-062 "/path/to/photos" --mode design-only --size auto,9:16 --text prompt --locale ar-SA
...
يمكن لمستخدمي Claude Code ربط المجلد نفسه بالمسار: `~/.claude/skills/xxd-panel-062`. أعد تشغيل جلسة الوكيل بعد التثبيت.
...
المواصفات الكاملة: [مسار عمل المهارة](SKILL.md) · [أرشيف الأسلوب الأصلي](references/original-prompt/zh-CN.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-062-prompt.en.md) · [مهايئ التشغيل الصيني](references/xxd-panel-062-prompt.zh-CN.md)
...
| **[xxd-panel-062](https://github.com/nevertoday/xxd-panel-062)** | شكل أسود رئيسي · فراغ هائل · تلاشي هالف تون · تأمل زِنّي · شظايا فكر |
...
| **الجنود** | `xxd-panel-NNN` (حالياً 001–062) | تنفذ كل مهارة مرقمة موجّهها الأصلي وجماليتها الخاصة فقط، وتنجز المهمة الفردية التي يرسلها الجنرال. |
