...
```text
/xxd-panel-062 <source-or-directory> --mode top-bottom,design-only \
...
1. 上下对照（原图在上，062 设计在下）
2. 左右对照（原图在左，062 设计在右）
...
```text
~/Desktop/xxd/xxd-panel-062/<fresh-task>/
...
- `references/xxd-panel-062-prompt.zh-CN.md`
- `references/xxd-panel-062-prompt.en.md`
